...
(def compile-one-data2
  {:doc                     "Modify department"
   ...
   :dadysql.core/extend     {:insert-dept {:dadysql.core/default-param [:transaction_id (fn [_] 0)]
...
(def compile-one-expected-result
  [{:dadysql.core/timeout    30,
    :doc                     "Modify department"
    :dadysql.core/param-spec :tie-edn2/get-dept-by-id,
    :dadysql.core/default-param [:transaction_id (fn [_] 0)]
...
(def do-compile-input-data
  [{:dadysql.core/name         :_global_
    ...
    :spec-model.core/join         [[:department :id :spec-model.core/rel-1-n :employee :dept_id]
                                [:employee :id :spec-model.core/rel-1-1 :employee-detail :employee_id]
                                [:employee :id :spec-model.core/rel-n-n :meeting :meeting_id [:employee-meeting :employee_id :meeting_id]]]}
...
(def do-compile-expected-result
  {:_global_
   ...
   {:dadysql.core/timeout    5000,
    ...
    :dadysql.core/default-param [:limit (fn [_] 10)
                                 :offset (fn [_] 0)]
    :spec-model.core/join       [[:department :id :1-n :employee :dept_id]],
   ...
   {:dadysql.core/timeout    5000,
    ...
    :dadysql.core/default-param [:limit (fn [_] 10)
                                 :offset (fn [_] 0)]
    :spec-model.core/join       [[:employee :id :1-1 :employee-detail :employee_id]
   ...
   {:dadysql.core/timeout    5000,
    ...
    :dadysql.core/default-param [:limit (fn [_] 10)
                                 :offset (fn [_] 0)]
    :spec-model.core/join       [[:meeting :meeting_id :n-n :employee :id [:employee-meeting :meeting_id :employee_id]]],
