...
(deftest do-join-test
  (testing "test do-join "
    (let [join [[:tab :id :spec-model.core/rel-1-n :tab2 :tab-id]
                [:tab :id :spec-model.core/rel-1-n :tab3 :tab-id]]
  ...
  (testing "test do-join "
    (let [join [[:tab :id :spec-model.core/rel-1-1 :tab1 :tab-id]
                ...
                [:tab :id :spec-model.core/rel-n-n :tab2 :id [:tab-tab1 :tab-id :tab2-id]]]
...
#_(let [join [[:tab :id :spec-model.core/rel-1-n :tab1 :tab-id]]
      data {:tab {:id   100
                  :tab1 [{ :name "name1"}
                         { :name "name2"}]}}
...
#_(deftest group-by-join-src-test
  (testing "test group-by-join-src "
    (let [v [[:tab :id :spec-model.core/rel-1-n :tab1 :tab-id]]
          expected-result {:tab {:spec-model.core/join [[:tab :id :spec-model.core/rel-1-n :tab1 :tab-id]]}}
...
#_(deftest join-emission-batch-test
  (testing "test join-emission-batch "
    (let [join [[:tab :ID :spec-model.core/rel-1-n :tab2 :tab-id]
                [:tab :id :spec-model.core/rel-1-n :tab3 :tab-ID]
                [:tab :id :spec-model.core/rel-n-n :tab1 :tab-id [:ntab :tab-ID :tab1-id]]]
          expected-result [[:tab :id :spec-model.core/rel-1-n :tab2 :tab-id]
                           [:tab :id :spec-model.core/rel-1-n :tab3 :tab-id]
                           [:tab :id :spec-model.core/rel-n-n :tab1 :tab-id [:ntab :tab-id :tab1-id]]]
